function multipleChoise (choices: any[]) {
...
game.showLongText("You only have $2 dollars and an Arizona Iced Tea ", DialogLayout.Bottom)
if (game.ask("Drink the Iced Tea ", "walk 10 miles")) {
    gameover("The Iced Tea make you more thirsty,you die ")
} else {
    scene.setBackgroundImage(img`
        9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
    ...
    if (game.ask("Give the dinosaur $2 dollar ", "give the dnousar Iced Tea ")) {
        ...
        scene.setBackgroundImage(img`
            ...
            `)
        game.showLongText("he continue road and finally came city ", DialogLayout.Bottom)
        if (game.ask("he cane buy with $2 dollar food ", "he can buy something for drink ")) {
            game.showLongText("he will buy food because he is hungry ", DialogLayout.Bottom)
            game.over(true)
        } else {
            let list: number[] = []
            multipleChoise(list)
